...
function isTerminalEditor(editor) {
  return editor === 'vim' || editor === 'emacs' || editor === 'nano';
}
...
function printInstructions(fileName, _errorMessage) {
...
function launchEditor(_fileName, lineNumber, _colNumber) {
  let fileName = _fileName;
  let colNumber = _colNumber;
